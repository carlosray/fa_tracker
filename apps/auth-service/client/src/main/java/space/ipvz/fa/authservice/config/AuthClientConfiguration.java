package space.ipvz.fa.authservice.config;

import space.ipvz.fa.authservice.client.AuthServiceClient;
import space.ipvz.fa.authservice.client.impl.AuthServiceClientImpl;
