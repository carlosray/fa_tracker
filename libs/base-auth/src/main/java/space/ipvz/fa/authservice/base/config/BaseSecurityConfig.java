package space.ipvz.fa.authservice.base.config;

import space.ipvz.fa.authservice.base.permission.BasePermissionChecker;
import space.ipvz.fa.authservice.base.permission.aspect.PermissionAspect;
import space.ipvz.fa.authservice.base.service.PermissionChecker;
import space.ipvz.fa.authservice.base.service.impl.JwtAuthenticationConverter;
import space.ipvz.fa.authservice.base.service.impl.SecurityContextRepository;
